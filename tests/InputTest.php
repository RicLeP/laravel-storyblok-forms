...
class InputTest extends TestCase
{
	...
	public function can_get_fieldset_validation_errors() {
		...
		$errors = [
			...
			"client_details.client_9" => "Address line 1, line 2, town and postcode are required.",
	...
	public function real_world_can_get_form_validation_errors() {
		...
		$errors = [
			...
			"basic_risk_details.basic_6.*.basic_8.min" => "Value can not be negative",
			...
			"premises_to_be_insured.premises.*.risk_address_32.*.risk_address_34" => "Address line 1, line 2, town and postcode are required.",
			"premises_to_be_insured.premises.*.risk_address_40.risk_address_41" => "This must be a round number",
			"premises_to_be_insured.premises.*.risk_address_40.risk_address_41.min" => "Value can not be negative",
			"premises_to_be_insured.premises.*.risk_address_40.risk_address_41.max" => "Maximum value is £5m",
			...
			"premises_to_be_insured.premises.*.risk_address_42.risk_address_43.min" => "Value can not be negative",
			"premises_to_be_insured.premises.*.risk_address_42.risk_address_43.max" => "Maximum value is £1m",
			...
			"premises_to_be_insured.premises.*.risk_address_45.max" => "Maximum value is £1.5m",
			...
			"liab.liab_2.liab_3.min" => "This value can’t be negative",
